...
class TableViewController: UITableViewController {
    ...
    let socialApps = ["Facebook","Twitter","Instagram","LinkedIn"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = socialApps[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]?
    {
        ...
        let shareAction = UITableViewRowAction(style: UITableViewRowActionStyle.default, title: "Share" , handler: { (action:UITableViewRowAction, indexPath: IndexPath) -> Void in
            ...
            let twitterAction = UIAlertAction(title: self.socialApps[indexPath.row], style: UIAlertActionStyle.default, handler: nil)
